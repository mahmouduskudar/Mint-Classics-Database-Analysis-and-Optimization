...
SELECT 
    ...
    ROUND((ts.total_ordered_item / 18) * 12, 0) AS good_stock_level_sales, -- Assuming 12 months buffer for good stock level based on sales
    ROUND(ts.total_revenue / 18, 0) AS avg_monthly_revenue, -- Assuming 18-month period for average revenue calculation
    CASE
