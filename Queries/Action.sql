...
SELECT 
    ...
    ia.inventory_status,
    CASE
		WHEN ia.inventory_status = 'Overstocked' AND (ia.productScale LIKE '%1:700%' OR ia.productScale LIKE '%1:72%' OR ia.productScale LIKE '%1:50%' OR ia.productScale LIKE '%1:32%' OR ia.productScale LIKE '%1:24%') THEN 'Reduce'  -- reduce if scale is high
